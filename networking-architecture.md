...
{: caption="Classic edge gateway network enterprise connectivity architecture decisions"}
...
{: caption="Classic edge gateway network BYOIP and Edge Gateway architecture decisions"}
...
{: caption="Classic edge gateway network segmentation and isolation architecture decisions"}
...
{: caption="Classic edge gateway network cloud native connectivity architecture decisions"}
...
| Architecture decision       | Requirement                                                                                                            | Options                                                                                                                      | Decision                  | Rationale                                                                                                  |
|---------------------------------|----------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|-------------------------------|----------------------------------------------------------------------------------------------------------------|
| Global load balancing           | Load balancing over the public network across two regions if an outage (DR) occurs for failover to the other region. | - {{site.data.keyword.cis_full_notm}} (CIS)  \n - DNS services                                                                      | Cloud internet services (CIS) | Provides a cost-effective solution while offering more security features                                 |
| Load balancing (public/private) | Load balancing workloads across multiple workload instances or zones over the public network.                              | - IBM Cloud Load Balancer  \n - Citrix Netscaler VPX  \n - Network Load Balancer (NLB)  \n - Application Load Balancer (ALB)  \n - F5 Big-IP Load Balancer | Application Load Balancer     | Cost effectively provides a wide range of layer 7 load balancing functions for both public and private traffic |
{: caption="Classic edge gateway network load balancing architecture decisions"}
...
{: caption="Classic edge gateway network Domain Name System architecture decisions"}
